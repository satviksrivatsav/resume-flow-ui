        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
          ...
          <section className="bg-card/50 rounded-xl p-6 border border-border/50">
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              <li>
                ...
                when you create an account or sign in via social providers (Google, GitHub,
                LinkedIn).
              </li>
              <li>
                <strong>Resume Data:</strong> Personal information, work experience, education,
          ...
          <section className="bg-card/50 rounded-xl p-6 border border-border/50">
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              ...
              <li>
                <strong>Google Gemini AI:</strong> AI-powered content suggestions
              </li>
              <li>
                <strong>Social Login Providers:</strong> Google, GitHub, and LinkedIn for optional

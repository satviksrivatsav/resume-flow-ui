        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
          ...
          <section className="bg-card/50 rounded-xl p-6 border border-border/50">
            ...
            <p className="text-muted-foreground">
              ...
              edit, and export professional resumes. The Service includes features such as resume
          ...
          <section className="bg-card/50 rounded-xl p-6 border border-border/50">
            ...
            <p className="text-muted-foreground mt-4">
              You are solely responsible for ensuring the accuracy and legality of your resume
              content.
            </p>
          </section>
          ...
          <section className="bg-card/50 rounded-xl p-6 border border-border/50">
            ...
            <p className="text-muted-foreground">
              The Service uses artificial intelligence to generate content suggestions. While we
              strive for accuracy, AI-generated content may contain errors or inaccuracies. You are
              responsible for reviewing and verifying all AI-generated suggestions before including
              them in your resume. We do not guarantee that AI suggestions will result in job offers
              or interviews.
            </p>
          </section>
          ...
          <section className="bg-card/50 rounded-xl p-6 border border-border/50">
            ...
            <p className="text-muted-foreground">
              ...
              USE OF THE SERVICE, INCLUDING BUT NOT LIMITED TO LOSS OF DATA, LOSS OF EMPLOYMENT
          ...
          <section className="bg-card/50 rounded-xl p-6 border border-border/50">
            ...
            <p className="text-muted-foreground">
              ...
              use the Service will immediately cease. You may also delete your account at any time

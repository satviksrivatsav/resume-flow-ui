...
import { Sparkles, ShieldCheck, Zap, Layout, ArrowRight } from "lucide-react";
import { cn } from "@/lib/utils";

const features = [
  {
    title: "AI Writing Assistant",
    description: "Rewrite any bullet point in seconds. Our AI surfaces your best achievements while keeping your voice intact.",
    icon: Sparkles,
    color: "bg-zinc-500",
  },
  {
    title: "ATS Optimization",
    description: "Beat automated filters before a human even reads your resume. Engineered to pass ATS scans cleanly.",
    icon: ShieldCheck,
    color: "bg-zinc-400",
  },
  {
    title: "Instant Formatting",
    description: "Pick a template, fill in your details, and download a pixel-perfect PDF in minutes. No design tools needed.",
    icon: Zap,
    color: "bg-zinc-600",
  },
  {
    title: "Modern Templates",
    description: "Clean, professional, and distinct designs that put your experience in the spotlight it deserves.",
    icon: Layout,
    color: "bg-zinc-300",
  },
];
